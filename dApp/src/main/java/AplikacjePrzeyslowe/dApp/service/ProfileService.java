...
import AplikacjePrzeyslowe.dApp.dto.request.UpdateProfileRequest;
import AplikacjePrzeyslowe.dApp.dto.response.InterestResponse;
import AplikacjePrzeyslowe.dApp.dto.response.PhotoResponse;
import AplikacjePrzeyslowe.dApp.dto.response.ProfileResponse;
import AplikacjePrzeyslowe.dApp.entity.Interest;
import AplikacjePrzeyslowe.dApp.entity.Photo;
...
import AplikacjePrzeyslowe.dApp.repository.PhotoRepository;
import AplikacjePrzeyslowe.dApp.repository.ProfileRepository;
...
public class ProfileService {
    ...
    /**
     * Pobiera Profile entity (do użytku wewnętrznego).
     * @param userId ID użytkownika

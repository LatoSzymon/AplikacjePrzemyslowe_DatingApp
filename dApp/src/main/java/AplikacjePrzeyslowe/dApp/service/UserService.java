...
import AplikacjePrzeyslowe.dApp.dto.request.RegisterRequest;
import AplikacjePrzeyslowe.dApp.dto.response.UserResponse;
import AplikacjePrzeyslowe.dApp.entity.Gender;
import AplikacjePrzeyslowe.dApp.entity.User;
import AplikacjePrzeyslowe.dApp.exception.ResourceAlreadyExistsException;
...
import AplikacjePrzeyslowe.dApp.repository.UserRepository;
...
public class UserService {
    ...
    /**
     * Pobiera User entity (do użytku wewnętrznego w innych serwisach).
     * @param userId ID użytkownika
     * @return User entity
     */
    @Transactional(readOnly = true)

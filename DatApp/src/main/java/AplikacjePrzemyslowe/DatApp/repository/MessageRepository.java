...
public interface MessageRepository extends JpaRepository<Message, Long> {
    ...
    /**
     * Znajduje wszystkie wiadomości dla danego matcha (paginowane)
     */
    Page<Message> findByMatchOrderBySentAtAsc(Match match, Pageable pageable);

    /**
     * Znajduje wszystkie wiadomości dla danego matcha (niepaginowane)
     */
    ...
    /**
     * Liczy nieprzeczytane wiadomości dla użytkownika (jako odbiorca)
     */
